<?php
 ...
 $connect_string="mysql://username:password@localhost/thelist";
 $default_theme="thelist";

 $config_version = 0.1;
 $site_name = 'Libre.fm';
 $base_url = 'https://libre.fm';
 $submissions_server = 'http://turtle.libre.fm/';
 $install_path = '/var/www/html';
 $gnufm_key = 'werereallylibrefmhonestwouldilie';
 $friendly_urls=true;
